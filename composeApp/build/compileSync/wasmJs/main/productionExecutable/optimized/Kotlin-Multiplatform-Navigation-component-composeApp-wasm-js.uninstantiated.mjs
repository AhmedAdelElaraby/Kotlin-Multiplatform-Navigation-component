...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const wasmFilePath = './Kotlin-Multiplatform-Navigation-component-composeApp-wasm-js.wasm';
    const importObject = {
        js_code,
        intrinsics: {
    ...
    try {
      ...
      if (isBrowser) {
        wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./Kotlin-Multiplatform-Navigation-component-composeApp-wasm-js.wasm',import.meta.url).href), importObject)).instance;
      }
    } catch (e) {
