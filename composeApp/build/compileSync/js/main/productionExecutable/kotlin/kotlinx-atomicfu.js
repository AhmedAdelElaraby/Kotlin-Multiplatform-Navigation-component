(function (factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).dm = function () {
  ...
  protoOf(AtomicRef).em = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicRef).fm = function () {
  ...
  protoOf(AtomicBoolean).gm = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicBoolean).fm = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicInt).hm = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicInt).fm = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  protoOf(AtomicLong).im = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).fm = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).dm);
  //endregion
